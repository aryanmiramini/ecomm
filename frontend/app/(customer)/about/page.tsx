...
export default function AboutPage() {
  ...
  const statsDisplay = [
    { 
      value: stats ? `${toPersianNumber(stats.yearsExperience)}+` : null, 
      label: "سال تجربه", 
      icon: Award 
    },
    { 
      value: stats ? `${toPersianNumber(stats.totalCustomers)}+` : null, 
      label: "مشتری راضی", 
      icon: Users 
    },
    { 
      value: stats ? `${toPersianNumber(stats.totalProducts)}+` : null, 
      label: "محصول متنوع", 
      icon: ShoppingBag 
    },
    { 
      value: stats ? `${toPersianNumber(stats.satisfactionRate)}٪` : null, 
      label: "رضایت مشتریان", 
      icon: TrendingUp 
    },
  ]
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <Badge className="mb-4 bg-primary/10 text-primary border-primary/20 px-4 py-2">
              ...
              {loading ? "در حال بارگیری..." : `بیش از ${toPersianNumber(stats?.yearsExperience || 10)} سال تجربه`}
            </Badge>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ما با هدف ارائه بهترین محصولات و خدمات به مشتریان عزیز فعالیت می‌کنیم. 
              اعتماد هزاران مشتری، بزرگترین افتخار ماست.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <Badge className="mb-4" variant="secondary">داستان ما</Badge>
            <h2 className="text-3xl font-bold text-foreground mb-6">
              سفری به سوی کیفیت و اعتماد
            </h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                فروشگاه آنلاین ما با هدف ارائه بهترین محصولات و خدمات به مشتریان عزیز تاسیس شده است. 
                ما با بیش از {loading ? "..." : toPersianNumber(stats?.yearsExperience || 10)} سال تجربه در زمینه فروش آنلاین، 
                توانسته‌ایم اعتماد {loading ? "..." : toPersianNumber(stats?.totalCustomers || 0)}+ مشتری را جلب کنیم.
              </p>
              <p>
                تیم ما متشکل از متخصصان با تجربه است که همواره در تلاش برای بهبود کیفیت خدمات و 
                رضایت مشتریان هستند. ما اعتقاد داریم که کیفیت، قیمت مناسب و خدمات پس از فروش عالی، 
                کلیدهای موفقیت در این حوزه هستند.
              </p>
              <p>
                در حال حاضر ما {loading ? "..." : toPersianNumber(stats?.totalProducts || 0)}+ محصول متنوع 
                در {loading ? "..." : toPersianNumber(stats?.totalCategories || 0)} دسته‌بندی مختلف ارائه می‌دهیم.
              </p>
            </div>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Badge className="mb-4" variant="secondary">مزایای ما</Badge>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-primary to-accent text-white">
          <CardContent className="relative py-12 md:py-16 text-center z-10">
            ...
            <p className="text-white/80 max-w-xl mx-auto mb-8">
              همین حالا به جمع {loading ? "هزاران" : toPersianNumber(stats?.totalCustomers || 0)}+ مشتری راضی ما بپیوندید و از بهترین محصولات با بهترین قیمت‌ها بهره‌مند شوید
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline" className="border-2 border-white/50 text-white hover:bg-white/20 hover:border-white font-semibold">
